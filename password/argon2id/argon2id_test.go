...
import (
	...
	"github.com/cyberwlodarczyk/auth/password"
)
...
func TestDecode(t *testing.T) {
	...
	errors := []struct {
		...
		{"", password.ErrInvalidFormat},
		{"argon2id$$v=19$m==65536,t=1,p=1$UXBRcnJTa0p0VnExcmxuNA$O55J0XoGcpMf429Y/Lgq+Erwk8t7xuH++rtFw4boAXQ", password.ErrInvalidFormat},
		{"$argon2id$v=19$m=65536,t=1,p=1$YzA''''WlWZmcU5RaVN1Qw$P1/FafrWnhJ;Us7YE0wJthWPv0YOPO9jr5rAJgGdA", password.ErrInvalidFormat},
		{"$argon2d$v=19$m=65536,t=1,p=1$Rm5QSDJhTEh5a3diZjRCYQ$H5WBPRQIhoBlSPwtGBZ20OfBStL6S5BVjpfpF/j3waI", password.ErrIncompatibleVariant},
		{"$argon2id$v=18$m=65536,t=1,p=1$T3pwRTFrNzlZUFFmUnIybg$oebSb8wynxxVeX03ydN1goSOOtf7WOK3P8jGCqNPLgI", password.ErrIncompatibleVersion},
	}
